...
function SessionsDAO(db) {
    ...
    this.startSession = function (username, callback) {
        ...
        sessions.insertOne(session, function (err, result) {
            "use strict";
    ...
    this.endSession = function (session_id, callback) {
        ...
        sessions.removeOne({'_id': session_id}, function (err, numRemoved) {
            "use strict";
            callback(err);
        });
    };
    this.getUsername = function (session_id, callback) {
        ...
        sessions.find({'_id': session_id}).limit(1).next(function (err, session) {
            "use strict";
